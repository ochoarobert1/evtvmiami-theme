<?php
add_action( 'tgmpa_register', 'evtvmiami_register_required_plugins' );
 ...
 */
function evtvmiami_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'evtvmiami_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
